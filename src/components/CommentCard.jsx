      ...
      <div className='flex items-center gap-16'>
        ...
        <div className='flex flex-col gap-4'>
          <p className='text-black-700 text-base'>
            <span className='text-black-400 font-pretendard font-light text-xl leading-6 tracking-[0%]'>
              From.
            </span>{' '}
            <span className='font-pretendard font-bold text-[20px] leading-6 tracking-[0%]'>
              {name}
            </span>
          </p>
