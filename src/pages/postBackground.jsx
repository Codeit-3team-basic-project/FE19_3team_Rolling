...
function PostBackground() {
  ...
  const [backgroundData, setBackgroundData] = useState({
    backgroundColor: 'orange', // API enum 기본값
  ...
  const handleSingleImageSelect = useCallback(image => {
    ...
    setBackgroundData({
      backgroundColor: 'orange', // 이미지 선택 시 기본 컬러
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const newRecipientData = {
        team: '19-3',
        name: recipientName,
        backgroundColor: backgroundData.backgroundColor || 'orange', // 기본값 설정
      ...
      <div className='flex items-center justify-center p-4 mt-[45px]'>
        <div className='w-[720px] bg-white'>
          ...
          <div className='space-y-4 mt-[50px]'>
            <div>
              <h2
                className='font-semibold text-gray-900 mb-10'
                style={{ fontSize: '24px' }}
              >
                배경화면을 선택해 주세요.
              </h2>
            ...
            <div className='w-[244px] h-[40px] flex mt-[25px] mb-[62px]'>
              <button
                ...
                style={{
                  backgroundColor:
                    selectedTab === 'color' ? '#ffffff' : '#eeeeee',
                  color: selectedTab === 'color' ? '#9935ff' : '#181818',
                  borderColor:
                    selectedTab === 'color' ? '#861dee' : 'transparent',
              ...
              <button
                ...
                style={{
                  backgroundColor:
                    selectedTab === 'image' ? '#ffffff' : '#eeeeee',
                  color: selectedTab === 'image' ? '#9935ff' : '#181818',
                  borderColor:
                    selectedTab === 'image' ? '#861dee' : 'transparent',
